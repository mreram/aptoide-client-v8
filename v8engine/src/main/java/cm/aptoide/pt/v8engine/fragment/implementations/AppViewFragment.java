...
import com.eram.aban.AbanRepository;
...
public class AppViewFragment extends AptoideBaseFragment<BaseAdapter>
    ...
    private AbanRepository abanRepository;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        abanRepository = new AbanRepository();
    ...
    public void load(boolean create, boolean refresh, Bundle savedInstanceState) {
        ...
        if (appId >= 0) {
            ...
            subscription = appRepository.getApp(appId, refresh, sponsored, storeName, packageName)
                    ...
                    .flatMap(getApp -> Observable.merge(manageOrganicAds(getApp), getShamed(getApp)))
                    .flatMap(getApp -> Observable.merge(manageOrganicAds(getApp), getShamed(getApp)).onErrorReturn(throwable -> getApp))
