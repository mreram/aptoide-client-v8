...
public class SettingsFragment extends PreferenceFragmentCompat
  ...
  private static final String ADULT_CONTENT_CATEGORY_KEY = "adultContent";
  ...
  @Override public void onCreate(Bundle savedInstanceState) {
    ...
    showMatureContent = ((PartnerApplication) getContext().getApplicationContext()).getBootConfig()
        .getPartner()
        .getSwitches()
        .getMature()
        .isEnable();
  ...
  @Override public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
    ...
    if (showMatureContent) {
      ...
      removeCategoryFromSettings(ADULT_CONTENT_CATEGORY_KEY);
    }
